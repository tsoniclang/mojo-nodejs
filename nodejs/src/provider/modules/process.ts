...
export function processModule(): MojoProviderModuleDefinition {
  return Object.freeze({
    ...
    exports: Object.freeze([
      ...
      valueExport(moduleSpecifier, "stdin", providerRef("node:stream", "Readable")),
      valueExport(moduleSpecifier, "version", stringType),
...
function defaultProcessOperations(): readonly MojoProviderOperationDefinition[] {
  return Object.freeze([
    ...
    staticPropertyRead(defaultId, `${defaultId}.stdin`, "stream", "stdin", readableCarrier),
    staticPropertyRead(defaultId, `${defaultId}.version`, "process", "version", nativeString),
