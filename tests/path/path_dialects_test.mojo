...
def main() raises:
    ...
    assert_equal(windows.normalize("C:work\\..\\assets"), "C:assets")
    assert_equal(windows.normalize("\\\\host\\share\\..\\asset"), "\\\\host\\share\\asset")
    ...
    assert_equal(windows.relative("C:\\work\\posts", "c:\\WORK\\Assets"), "..\\Assets")
    assert_equal(windows.relative("C:\\one", "D:\\two"), "D:\\two")
    assert_equal(resolve_with_cwd(strings("C:article.md"), "D:\\work", "C:\\content"), "C:\\content\\article.md")
    assert_equal(resolve_with_cwd(strings("C:article.md"), "D:\\work"), "C:\\article.md")
    assert_equal(windows.to_namespaced_path("C:\\work\\article.md"), "\\\\?\\C:\\work\\article.md")
    assert_equal(windows.to_namespaced_path("\\\\host\\share\\article.md"), "\\\\?\\UNC\\host\\share\\article.md")
    assert_equal(posix.to_namespaced_path("C:\\work\\article.md"), "C:\\work\\article.md")
