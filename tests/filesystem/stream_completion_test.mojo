...
def encoded_completion(root: String) raises:
    ...
    _ = alias.write_buffer_encoded(Buffer.from_string("A"), String("not-an-encoding"), completion(trace, path, "b"))
    ...
    _ = alias.end_value_encoded(StreamChunk(Buffer.from_string("C")), String("ignored"), completion(trace, path, "z"))
