...
def line_question_and_eof() raises:
    ...
    var retained_alias = interface.on_line("line", selected)
    _ = retained_alias.on_line("line", selected)
    _ = interface.off_line("line", selected)
    _ = retained_alias.once_line("line", line(trace, "once"))
    ...
    retained_alias.question("", line(trace, "wrong-tail-answer"))
