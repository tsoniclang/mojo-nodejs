...
from .callbacks import ZlibCallback, ZlibInfoCallback, ZlibResultCallback, enqueue, enqueue_info, enqueue_result
...
def gzip_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _GZIP, CodecOptions(options))


def gzip_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def gzip_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _GZIP, options, callback)


def gzip_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _GZIP, CodecOptions(options), callback)


def gzip_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def gunzip_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _GUNZIP, CodecOptions(options))


def gunzip_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def gunzip_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _GUNZIP, options, callback)


def gunzip_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _GUNZIP, CodecOptions(options), callback)


def gunzip_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def deflate_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _DEFLATE, CodecOptions(options))


def deflate_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def deflate_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _DEFLATE, options, callback)


def deflate_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _DEFLATE, CodecOptions(options), callback)


def deflate_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def inflate_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _INFLATE, CodecOptions(options))


def inflate_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def inflate_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _INFLATE, options, callback)


def inflate_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _INFLATE, CodecOptions(options), callback)


def inflate_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def deflate_raw_sync_options(input: Buffer, options: ZlibOptions) raises -> Buffer:
    return process(input, _DEFLATE_RAW, options)


def deflate_raw_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _DEFLATE_RAW, CodecOptions(options))


def deflate_raw_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def deflate_raw_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _DEFLATE_RAW, options, callback)


def deflate_raw_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _DEFLATE_RAW, CodecOptions(options), callback)


def deflate_raw_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def inflate_raw_sync_options(input: Buffer, options: ZlibOptions) raises -> Buffer:
    return process(input, _INFLATE_RAW, options)


def inflate_raw_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _INFLATE_RAW, CodecOptions(options))


def inflate_raw_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def inflate_raw_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _INFLATE_RAW, options, callback)


def inflate_raw_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _INFLATE_RAW, CodecOptions(options), callback)


def inflate_raw_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def unzip_sync_info_options(input: Buffer, options: ZlibOptions) raises -> ZlibInfo:
    return process_info(input, _UNZIP, CodecOptions(options))


def unzip_sync_result_options(input: Buffer, options: ZlibOptions) raises -> ZlibResult:
...
def unzip_callback_options(input: Buffer, options: ZlibOptions, callback: ZlibCallback) raises:
    enqueue(input, _UNZIP, options, callback)


def unzip_callback_info_options(input: Buffer, options: ZlibOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _UNZIP, CodecOptions(options), callback)


def unzip_callback_result_options(input: Buffer, options: ZlibOptions, callback: ZlibResultCallback) raises:
...
def brotli_compress_sync_options(input: Buffer, options: BrotliOptions) raises -> Buffer:
    return process(input, _BROTLI_COMPRESS, options)


def brotli_compress_sync_info_options(input: Buffer, options: BrotliOptions) raises -> ZlibInfo:
    return process_info(input, _BROTLI_COMPRESS, CodecOptions(options.copy()))


def brotli_compress_sync_result_options(input: Buffer, options: BrotliOptions) raises -> ZlibResult:
...
def brotli_compress_callback_options(input: Buffer, options: BrotliOptions, callback: ZlibCallback) raises:
    enqueue(input, _BROTLI_COMPRESS, options, callback)


def brotli_compress_callback_info_options(input: Buffer, options: BrotliOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _BROTLI_COMPRESS, CodecOptions(options.copy()), callback)


def brotli_compress_callback_result_options(input: Buffer, options: BrotliOptions, callback: ZlibResultCallback) raises:
    enqueue_result(input, _BROTLI_COMPRESS, CodecOptions(options.copy()), callback)
...
def brotli_decompress_sync_options(input: Buffer, options: BrotliOptions) raises -> Buffer:
    return process(input, _BROTLI_DECOMPRESS, options)


def brotli_decompress_sync_info_options(input: Buffer, options: BrotliOptions) raises -> ZlibInfo:
    return process_info(input, _BROTLI_DECOMPRESS, CodecOptions(options.copy()))


def brotli_decompress_sync_result_options(input: Buffer, options: BrotliOptions) raises -> ZlibResult:
    return process_result(input, _BROTLI_DECOMPRESS, CodecOptions(options.copy()))
...
def brotli_decompress_callback_options(input: Buffer, options: BrotliOptions, callback: ZlibCallback) raises:
    enqueue(input, _BROTLI_DECOMPRESS, options, callback)


def brotli_decompress_callback_info_options(input: Buffer, options: BrotliOptions, callback: ZlibInfoCallback) raises:
    enqueue_info(input, _BROTLI_DECOMPRESS, CodecOptions(options.copy()), callback)


def brotli_decompress_callback_result_options(input: Buffer, options: BrotliOptions, callback: ZlibResultCallback) raises:
    enqueue_result(input, _BROTLI_DECOMPRESS, CodecOptions(options.copy()), callback)
