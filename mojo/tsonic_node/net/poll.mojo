from ..internal.network_endpoint import has_network_resolution, poll_network_resolution
...
def has_active_net() -> Bool:
    return has_network_resolution() or has_active_servers() or has_active_sockets()
