...
struct ServerOptions(Copyable):
    ...
    def __init__(out self, allow_half_open: Optional[Bool] = None, pause_on_connect: Optional[Bool] = None):
...
struct ConnectionOptions(Copyable):
    ...
    def __init__(out self, port: Float64, host: Optional[String] = None, allow_half_open: Optional[Bool] = None,
                 no_delay: Optional[Bool] = None, timeout: Optional[Float64] = None):
        self.port = port
        self.host = host
        self.allow_half_open = allow_half_open
