...
def _open(path: String, flags: String, mode: Optional[Float64]) raises -> StreamDescriptor:
    return StreamDescriptor(Int32(open_file(path, flags, mode.value() if mode else Float64(0o666))), True)
